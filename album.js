...
function renderAlbums(filterArtist = "All") {
  ...
  Object.keys(albumData).forEach(albumName => {
    ...
    let albumArtist = "";
    if (["Goodcat Code","Valleydream Bloom","Passionate Appraisal","Innocent Birdcage","Alternative Darkborne","Abyssal Mark","Abyssal Blossom","Long-Awaited Reverly","Absurdity Unfolds","Midnight Stealth", "Magnum Opus", 
